<template>
	<div class="memberrechargeadd">
		<div class="title"><img src="../../assets/daohang.png"> 当前位置：<router-link tag='span' to='/memberrecharge'>会员充值活动</router-link> > 添加活动会员</div>

		<div class="title title1"><img src="../../assets/huiyuan03.png"> 添加活动会员</div>

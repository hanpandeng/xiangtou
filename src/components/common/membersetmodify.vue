<template>
	<div class="membersetmodify">
		<div class="title"><img src="../../assets/daohang.png"> 当前位置：<router-link tag='span' to='/memberset'>会员设置</router-link> > 会员修改</div>
		
		<div class="title title1"><img src="../../assets/huiyuan01.png"> 会员修改</div>
			...
			query(){
				...
				axios({
					...
					if(res.data.code == 200){
						...
						that.name = res.data.data.memberName
						that.price = res.data.data.memberMoney
						that.discount = res.data.data.memberDiscounts
						that.img = res.data.data.memberIcon 

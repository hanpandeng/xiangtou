<template>
	<div class="labelsee">
		<div class="title"><img src="../../assets/daohang.png"> 当前位置：<router-link tag='span' to='/labels'>标签管理</router-link> > 查看</div>
		
		<div class="title title1"><img src="../../assets/biaoqian2.png"> 查看</div>
		...
		<div class="search"> 
			...
			<span class="chaxun chaxun1 shanchu" @click='remove()'>
				删除
			</span>
	...
	export default{
		...
		methods:{
			query(){
				var that = this;
				axios({
					url:'Selladvterise/selllabeladvPagelist',
					method:'get',
					params:{
